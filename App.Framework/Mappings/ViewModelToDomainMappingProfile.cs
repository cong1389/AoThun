...
namespace App.Framework.Mappings
{
    public class ViewModelToDomainMappingProfile : Profile
    {
        ...
        public ViewModelToDomainMappingProfile()
        {
            ...
            CreateMap<ContactInformationViewModel, ContactInformation>().ForMember((ContactInformation x) => (object)x.Id, map => map.MapFrom<int>((ContactInformationViewModel vm) => vm.Id)).ForMember((ContactInformation x) => x.Language, map => map.MapFrom<string>((ContactInformationViewModel vm) => vm.Language)).ForMember((ContactInformation x) => (object)x.Status, map => map.MapFrom<int>((ContactInformationViewModel vm) => vm.Status)).ForMember((ContactInformation x) => x.Lag, map => map.MapFrom<string>((ContactInformationViewModel vm) => vm.Lag)).ForMember((ContactInformation x) => x.Lat, map => map.MapFrom<string>((ContactInformationViewModel vm) => vm.Lat)).ForMember((ContactInformation x) => x.NumberOfStore, map => map.MapFrom<string>((ContactInformationViewModel vm) => vm.NumberOfStore)).ForMember((ContactInformation x) => (object)x.Type, map => map.MapFrom<int>((ContactInformationViewModel vm) => vm.Type)).ForMember((ContactInformation x) => (object)x.OrderDisplay, map => map.MapFrom<int>((ContactInformationViewModel vm) => vm.OrderDisplay)).ForMember((ContactInformation x) => (object)x.Status, map => map.MapFrom<int>((ContactInformationViewModel vm) => vm.Status)).ForMember((ContactInformation x) => x.Email, map => map.MapFrom<string>((ContactInformationViewModel vm) => vm.Email)).ForMember((ContactInformation x) => x.Hotline, map => map.MapFrom<string>((ContactInformationViewModel vm) => vm.Hotline)).ForMember((ContactInformation x) => x.Address, map => map.MapFrom<string>((ContactInformationViewModel vm) => vm.Address)).ForMember((ContactInformation x) => x.MobilePhone, map => map.MapFrom<string>((ContactInformationViewModel vm) => vm.MobilePhone)).ForMember((ContactInformation x) => x.Fax, map => map.MapFrom<string>((ContactInformationViewModel vm) => vm.Fax)).ForMember((ContactInformation x) => x.Province, map => map.Ignore()).ForMember((ContactInformation x) => (object)x.ProvinceId, map => map.MapFrom<int>((ContactInformationViewModel vm) => vm.ProvinceId));
